...
var Facebook = /*#__PURE__*/function (_BaseEmbed) {
  ...
  _createClass(Facebook, [{
    ...
    value: function validate() {
      ...
      var html = '<div class="fb-post" data-href="' + this.props.url + '" data-width="750"></div>';
      if (this.props.url.indexOf('/videos/') > 0) {
        html = '<div class="fb-video" data-href="' + this.props.url + '" data-allowfullscreen="true" data-width="750"></div>';
      }
      this.setState({
    ...
    value: function render() {
      if (this.state.valid) {
        if (!this.state.preview) {
          ...
          }, /*#__PURE__*/_react["default"].createElement("p", null, "Facebook - ", /*#__PURE__*/_react["default"].createElement("a", {
            href: this.props.url,
            target: "_blank",
...
(function () {
  ...
  reactHotLoader.register(Facebook, "Facebook", "/Users/ujjwalmishra/Work/stck/kattappa/src/blocks/embeds/facebook.js");
  reactHotLoader.register(_default, "default", "/Users/ujjwalmishra/Work/stck/kattappa/src/blocks/embeds/facebook.js");
})();
;
(function () {
